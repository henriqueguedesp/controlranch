...
$rotas->add('raiz', new Route('/', array('_controller' => 'SerraBonita\Controllers\ControleIndex',
    '_method' => 'home'))); //chama todas noticias 
...
$rotas->add('imagens', new Route('/galeria', array('_controller' =>
    'Newspaper\Controllers\ControleImagem',
    '_method' => 'imagens')));
